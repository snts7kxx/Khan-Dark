...
// Tela inicial
  splashScreen.innerHTML = '<span style="color:white;text-shadow: 0 0 1px rgba(255,255,255,0.8);"><strong>KHAN</strong><span style="color:#af00ff;text-shadow: 0 0 1px rgba(255,255,255,0.67);"><strong>DARK</strong>';
