...
/* ═══════════════════════════════════════════════════
   INTERCEPTOR INSTALADO PRIMEIRO — antes de qualquer
   script externo ser carregado
═══════════════════════════════════════════════════ */
        ...
        try {
            ...
            if (answers.length > 0) {
                ...
                if (numericAnswers.length > 0) {
                    autoFillNumericAnswers(numericAnswers);
                }
            }
...
document.head.appendChild(Object.assign(document.createElement('style'), {
    innerHTML: `
        ...
        .kd-logo-text{font-size:72px;font-weight:bold;letter-spacing:4px;display:inline-block}
        ...
        .kd-progress-bar{width:100%;height:6px;background:rgba(175,0,255,0.1);border-radius:10px;overflow:hidden;position:relative}
...
async function showSplashScreen() {
    ...
    splashScreen.innerHTML = `
        ...
        <div class="kd-version">v2.2 • SNTS7KXX</div>
    `;
