...
// Tela inicial
  splashScreen.innerHTML = '<span style="color:white;text-shadow: 0 0 2px rgba(255,255,255,0.6);"><strong>KHAN</strong><span style="color:#af00ff;text-shadow: 0 0 2px rgba(255,255,255,0.6);"><strong>DARK</strong>';
